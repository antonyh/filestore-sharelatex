...
module.exports = FileController = {
  getFile (req, res) {
    ...
    return FileHandler.getFile(bucket, key, options, (err, fileStream) => {
      if (err != null) {
  ...
  insertFile (req, res) {
    ...
    return FileHandler.insertFile(bucket, key, req, err => {
      if (err != null) {
  ...
  copyFile (req, res) {
    ...
    return PersistorManager.copyFile(bucket, `${oldProject_id}/${oldFile_id}`, key, err => {
      if (err != null) {
  ...
  deleteFile (req, res) {
    ...
    return FileHandler.deleteFile(bucket, key, err => {
      if (err != null) {
  ...
  directorySize (req, res) {
    ...
    return FileHandler.getDirectorySize(bucket, project_id, (err, size) => {
      if (err != null) {
